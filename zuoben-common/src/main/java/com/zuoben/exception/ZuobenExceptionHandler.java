...
import com.zuoben.util.ReturnDTOUtil;
...
@ControllerAdvice
@ResponseBody
public class ZuobenExceptionHandler {
...
//    }
     ...
     * @return
     */
    @ExceptionHandler(ZuobenException.class)
    public ResponseEntity<ReturnDTO> handleBlifeException(ZuobenException e) {
        logger.info(e.getError());
